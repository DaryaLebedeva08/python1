...
def list_rand_nums(count):
    if count < 0:
        print ("не возможно посчитать произведение пар чисел так как введенное число не удовлетворяет заданным требованиям")
        return []
...
all_list = list_rand_nums(int(input("количество чисел ")))
print(all_list)
